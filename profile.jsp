<%-- 
    Document   : profile
    Created on : 3 Jul, 2020, 10:33:32 AM
    Author     : dprisky
--%>
  ...
  <div class="container">
   ...
   <div class="profile">
   	 <div class="col-md-8 profile_left">
			...
			%>
                        <h3 style='color:green'>Password Changed</h3><br>;
                        <%
                        }
		%>
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="images/<%=rs.getString("code")%>.jpg">
							<img src="images/<%=rs.getString("code")%>.jpg" />
						</li>
				...
				<table class="table_working_hours">
		        	<tbody>
						...
						<tr class="opened">
							...
							<td class="day_value"><%=rs.getString("mobile")%></td>
						</tr>
